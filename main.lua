...
function love.load()
	...
	for i = 1, NUM_BLOCKS do
		local obj = {}
		obj.body = love.physics.newBody(world, i * 55, 550, "kinematic")
...
function love.update(dt)
	...
	for i, obj in ipairs(objects.blocks) do
		...
		obj.body:setLinearVelocity(0, (altura - y) * velocidade)
	end 
	...
	elseif love.keyboard.isDown("w") then
		alturas[1] = alturas[1] - velocidade
...
function love.draw()
	love.graphics.setColor(72/255, 160/255, 14/255) -- set the drawing color to green for the ground
	love.graphics.polygon("fill", objects.ground.body:getWorldPoints(objects.ground.shape:getPoints())) -- draw a "filled in" polygon using the ground's coordinates

	love.graphics.setColor(193/255, 47/255, 14/255) --set the drawing color to red for the ball
	love.graphics.circle("fill", objects.ball.body:getX(), objects.ball.body:getY(), objects.ball.shape:getRadius())

	love.graphics.setColor(50/255, 50/255, 50/255) -- set the drawing color to grey for the blocks
	for i, obj in ipairs(objects.blocks) do
		love.graphics.polygon("fill", obj.body:getWorldPoints(obj.shape:getPoints()))
		love.graphics.points(obj.body:getX(), alturas[i])
	end
end